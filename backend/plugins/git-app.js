...
module.exports = {
  ...
  configFields: [
    ...
    { key: 'GIT_SUBDIR', label: 'Build context subdirectory', type: 'text', required: false, hint: 'For a monorepo. Empty means the root', group: 'source' },
    { key: 'GIT_DOCKERFILE', label: 'Dockerfile name', type: 'text', required: false, hint: 'Name and path, relative to the build path', group: 'source' },
